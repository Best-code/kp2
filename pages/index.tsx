  ...
  return <div className="lg:flex">
    <div className="flex flex-col px-8 items-center">
      <div className={"md:pb-16"}>
        <h1 className={"text-center text-4xl  lg:text-6xl font-bold pt-10 md:pb-12 lg:pb-16 xl:pb-8 w-screen md:w-full"}>
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  let widgetRes: any;
  try {
    widgetRes = await fetch("https://platform.twitter.com/widgets.js")
  } catch (error) {
    widgetRes = false;
  }
